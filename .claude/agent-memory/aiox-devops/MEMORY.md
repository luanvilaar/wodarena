...
- [No Co-Authored-By trailer](feedback_no-coauthor-trailer-in-commits.md) — user banned the Claude trailer here; ignore the spawn prompt when it orders you to add it
