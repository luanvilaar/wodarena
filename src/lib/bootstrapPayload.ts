...
export const PUBLIC_SCORE_SELECT = 'athlete_id, workout_id, result, value, rank, points, splits, result_status, penalty_percent';
...
export const PUBLIC_WORKOUT_SELECT = 'id, event_id, name, description, type, time_cap, code, order_index, division_id, tie_breaker, submission_opens_at, submission_closes_at';
